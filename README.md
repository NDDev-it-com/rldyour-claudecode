...
**9 first-party plugins** (32 skills, 10 slash commands, 8 subagents, 9 hook scripts in 2 manifests, 46 scripts total, 16 references). CI: 11 workflows + 1 dependabot config. Serena memories: 18.
...
| `rldyour-flow` | `0.6.3` | 7 | 6 | 6 | 5 | 7 | 7 | 0 | 0 |
