...
**9 first-party plugins** (32 skills, 10 slash commands, 8 subagents, 9 hook scripts in 2 manifests, 44 scripts total, 16 references). CI: 10 workflows + 1 dependabot config. Serena memories: 18.

| Plugin | Version | Skills | Commands | Agents | Hooks | Scripts | References | MCP | LSP |
|---|---|---|---|---|---|---|---|---|---|
| `rldyour-mcps` | `0.6.2` | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 0 |
| `rldyour-explore` | `0.6.2` | 2 | 1 | 1 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-serena-mcp` | `0.6.2` | 2 | 0 | 1 | 4 | 3 | 0 | 0 | 0 |
| `rldyour-security` | `0.6.2` | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-browser` | `0.6.2` | 3 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-design` | `0.6.2` | 5 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-lsps` | `0.6.2` | 4 | 0 | 0 | 0 | 2 | 3 | 0 | 1 |
| `rldyour-flow` | `0.6.2` | 7 | 6 | 6 | 5 | 7 | 7 | 0 | 0 |
| `rldyour-rules` | `0.6.2` | 7 | 1 | 0 | 0 | 0 | 6 | 0 | 0 |
