...
**9 first-party plugins** (32 skills, 9 slash commands, 8 subagents, 8 hook scripts in 2 manifests, 41 scripts total, 16 references). CI: 8 workflows + 1 dependabot config. Serena memories: 18.
