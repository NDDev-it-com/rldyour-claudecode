...
**10 first-party plugins** (38 skills, 11 slash commands, 8 subagents, 10 hook scripts in 2 manifests, 51 scripts total, 16 references). CI: 11 workflows + 1 dependabot config. Serena memories: 0.
