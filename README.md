...
**10 first-party plugins** (38 skills, 11 slash commands, 8 subagents, 10 hook scripts in 2 manifests, 52 scripts total, 16 references). CI: 11 workflows + 1 dependabot config. Serena memories: 0.

| Plugin | Version | Skills | Commands | Agents | Hooks | Scripts | References | MCP | LSP |
|---|---|---|---|---|---|---|---|---|---|
| `rldyour-mcps` | `1.3.5` | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 0 |
| `rldyour-explore` | `1.3.5` | 2 | 1 | 1 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-serena-mcp` | `1.3.5` | 2 | 0 | 1 | 4 | 3 | 0 | 0 | 0 |
| `rldyour-security` | `1.3.5` | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-browser` | `1.3.5` | 6 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-design` | `1.3.5` | 5 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-lsps` | `1.3.5` | 4 | 0 | 0 | 0 | 2 | 3 | 0 | 1 |
| `rldyour-flow` | `1.3.5` | 8 | 7 | 6 | 6 | 8 | 7 | 0 | 0 |
| `rldyour-orchestrator` | `1.3.5` | 2 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rldyour-rules` | `1.3.5` | 7 | 1 | 0 | 0 | 0 | 6 | 0 | 0 |
