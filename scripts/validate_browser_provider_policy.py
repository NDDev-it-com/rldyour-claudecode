...
def validate() -> None:
    ...
    require(chrome.get("args") == CHROME_ARGS, "chrome-devtools must use the exact managed CloakBrowser wrapper invocation")
...
def main() -> int:
    ...
    try:
        ...
        return 1
    print("ok: Claude browser provider policy validated")
    return 0
