---
name: ry-deploy
description: "Deploy с sync local↔GitHub↔server, проверками логов, fix-forward и docs/git финализацией. Используй для: /ry-deploy, задеплой, deploy, прод, продакшен, деплой на сервер, выкатить."
---
