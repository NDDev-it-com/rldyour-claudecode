...
description: "Ревьюер проверок для explicit /ry-start review или /ry-review. EN: orchestrated read-only verification-review subagent for tests, quality gates, browser evidence, and deploy proof."
model: sonnet
effort: high
maxTurns: 90
tools:
