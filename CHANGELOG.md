...
- Use audit-mode egress for reusable CodeQL workflow.
...
- Refresh tracked Serena release memory for the Claude adapter so root strict memory semantics recognizes the current tracked-context release line.
...
- Align marketplace and per-plugin manifest versions with the Claude adapter
  product version so release and validate workflows can prove version parity.
...
- Refresh runtime baselines to Claude Code 2.1.175 and OpenCode 1.17.4.
...
- Refresh Claude Code runtime baseline to 2.1.169.
...
- Remove retired browser MCP wording from active security docs.

## [1.1.37] - 2026-06-08

### Fixed

- Refresh generated Claude inventory after documentation sync.
...
- Refresh Claude Code runtime baseline to 2.1.168.
...
- Refresh Claude Code runtime baseline to 2.1.160 with current upstream changelog evidence.
...
- Refresh Claude Code runtime baseline to 2.1.159 after live latest drift.
...
- Harden public release supply-chain CI.

## [1.1.12] - 2026-05-30

### Fixed

- Harden public free CI policy with Scorecard and bounded artifact retention.
