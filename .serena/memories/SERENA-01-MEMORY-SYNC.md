...
- For the 0.6.4 release sync wave at HEAD `3b0ad53`, `analyze_sync_scope.py --from-ref HEAD^ --to-ref HEAD` classified 25 files across 17 areas and targeted `CLAUDECODE-01-PLUGIN-CANON.md`, `CORE-02-MARKETPLACE.md`, `RELEASE-01-VALIDATION.md`, `SERENA-01-MEMORY-SYNC.md`, and `TECHDEBT-01-NOW.md`. This was a high-sync-focus release/config/CI wave, not a taxonomy-shape change.
