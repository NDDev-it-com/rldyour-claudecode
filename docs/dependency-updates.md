...
MCP `3.2.3`. Claude Code remains pinned independently at `2.1.220`.
...
- Currently configured at `2.1.220`, matching the CI pin read from `package.json`.
