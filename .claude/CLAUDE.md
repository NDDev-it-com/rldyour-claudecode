...
claims:
  ...
  claude_code_runtime_pin: "2.1.162"
...
## Changelog Adoption (v2.1.133 -> v2.1.162)

Verified against `code.claude.com/docs/en/changelog`, `code.claude.com/docs/en/model-config`, `references/claude-baseline.json`, `package.json`, and npm package metadata on 2026-06-04. Runtime pin: **v2.1.162**. Feature compatibility floor: **v2.1.146+**.
...
- v2.1.157-2.1.162 - Direct `.claude/skills` loading, package latest drift, agent JSON `waitingFor`, native `Grep`/`Glob` tool listing, and read-only config fallback behavior are recorded; marketplace plugins remain the first-party release surface.
