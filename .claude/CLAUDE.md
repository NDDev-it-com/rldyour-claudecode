...
claims:
  ...
  claude_code_runtime_pin: "2.1.156"
...
## Changelog Adoption (v2.1.133 -> v2.1.156)

Verified against `code.claude.com/docs/en/changelog`, `code.claude.com/docs/en/model-config`, `references/claude-baseline.json`, `package.json`, and npm package metadata on 2026-05-29. Runtime pin: **v2.1.156**. Feature compatibility floor: **v2.1.146+**.
...
- v2.1.156 - Opus 4.8 thinking-block API error hotfix is adopted as the current runtime pin for release readiness.
