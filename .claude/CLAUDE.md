...
claims:
  ...
  claude_code_runtime_pin: "2.1.160"
...
## Changelog Adoption (v2.1.133 -> v2.1.160)

Verified against `code.claude.com/docs/en/changelog`, `code.claude.com/docs/en/model-config`, `references/claude-baseline.json`, `package.json`, and npm package metadata on 2026-05-30. Runtime pin: **v2.1.160**. Feature compatibility floor: **v2.1.146+**.
...
- v2.1.157-2.1.160 - Direct `.claude/skills` loading and package latest drift are recorded; marketplace plugins remain the first-party release surface.
